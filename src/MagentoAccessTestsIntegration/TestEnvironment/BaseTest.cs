...
namespace MagentoAccessTestsIntegration.TestEnvironment
{
	internal partial class BaseTest
	{
		...
		public void TestFixtureSetup()
		{
			...
			this._magentoServiceLowLevelSoapV11410Ee = new MagentoServiceLowLevelSoap_v_1_14_1_0_EE( this._soapUserCredentials.ApiUser, this._soapUserCredentials.ApiKey, this._authorityUrls.MagentoBaseUrl, null, 300000, 30 );
