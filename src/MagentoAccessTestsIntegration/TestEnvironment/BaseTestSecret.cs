	...
	public static class GeneralTestCases
	{
		...
		public static IEnumerable TestStoresCredentials
		{
			get
			{
				...
				yield return new TestCaseData(new BaseTest.MagentoServiceSoapCredentials() { MagentoVersion = "1.9.2.4", SoapApiKey = "123123", SoapApiUser = "ForAutoTestingDoNotChangePass123123", StoreUrl = "http://127.0.0.1:7777/magento-1-9-2-4-ce" }).SetName("magento-1-9-2-4-ce");
				...
				//yield return new TestCaseData(new BaseTest.MagentoServiceSoapCredentials() { MagentoVersion = "2.1.0.0", SoapApiKey = "123123", SoapApiUser = "SoapUser", StoreUrl = "http://127.0.0.1:7777/magento-2-1-0-0-ce" }).SetName("magento-2-1-0-0-ce");
				yield return new TestCaseData(new BaseTest.MagentoServiceSoapCredentials() { MagentoVersion = "2.0.7.0", SoapApiKey = "123123", SoapApiUser = "SoapUser", StoreUrl = "http://127.0.0.1:7777/magento-2-0-7-0-ce" }).SetName("magento-2-0-7-0-ce");
